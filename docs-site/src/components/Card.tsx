...
export function Card({
  ...
  return (
    <Link
      to={to}
      className="group bg-zinc-900 border border-zinc-800 rounded-xl p-5 transition-all hover:border-violet-500/40 hover:bg-zinc-800/50 hover:-translate-y-0.5"
    >
      <div className="font-mono text-sm font-semibold text-violet-400 mb-2 group-hover:text-violet-300">
        {title}
      </div>
